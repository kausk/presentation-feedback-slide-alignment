...
def transform_image(img_path, center_lat_lon, frame_src_corners, slide_dst_corners, example_slide):
    ...
    dst_fn = example_slide
    dst_corners =  slide_dst_corners
...
def transform_all_in_path(vidFramePath, center_lat_lon, frame_src_corners, slide_dst_corners, example_slide):
    videoFrameNames = [ filename for filename in os.listdir(vidFramePath) if filename.endswith(".png") ]
    for v in videoFrameNames:
        transform_image(vidFramePath + v, center_lat_lon, frame_src_corners, slide_dst_corners, example_slide)