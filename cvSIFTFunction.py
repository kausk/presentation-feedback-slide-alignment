...
## returns number of matches, matched image
def matchVideoSlideSIFT(videoImage, slideImage):

    surfDetector = cv2.xfeatures2d.SIFT_create()

    videoImageKP, desV = surfDetector.detectAndCompute(videoImage, None)
    templateImageKP, desT = surfDetector.detectAndCompute(slideImage, None)
    ...
    img3 = cv2.drawMatches(slideImage,templateImageKP,videoImage,videoImageKP,good,None,**draw_params)
